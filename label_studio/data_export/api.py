...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        In Store Layout Map Enterprise, this endpoint will always return a 404 Not Found response with instructions to use the async export API.
...
#         description="""
#         Retrieve a list of files exported from the Store Layout Map UI using the Export button on the Data Manager page.
